...
The provided provided scripts can be used to generate spherical phantom with 60 nodes.
...
Connectivity matrices and node parcellation (atlas.nii.gz) for mapping connetcome are also provided
